        ...
        <div>
            <div className="mt-2 flex flex-col relative">
                ...
                <div className="text-white relative">
                    <input name={name} type={isVisible ? "text" : "password"} onChange={changeHandler} placeholder={value} required className="bg-[#151d25] rounded-md p-2 m-1 w-full"/>

                    <button className="absolute w-5 h-auto top-4 right-1 cursor-pointer" onClick={toggleIcon}>
                        {
                            isVisible
